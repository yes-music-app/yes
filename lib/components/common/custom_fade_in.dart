...
class CustomFadeInImage extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _CustomFadeInImageState();
}

/// The phases a [CustomFadeInImage] goes through.
@visibleForTesting
...
class _ImageProviderResolver {
  ...
  final _CustomFadeInImageState state;
  final _ImageProviderResolverListener listener;

  CustomFadeInImage get widget => state.widget;
...
class _CustomFadeInImageState extends State<CustomFadeInImage>
  ...
  @override
  void didUpdateWidget(CustomFadeInImage oldWidget) {
    ...
    setState(() {
      switch (_phase) {
        ...
        case FadeInImagePhase.waiting:
          if (_imageResolver._imageInfo != null) {
            // Received image data. Begin image fade-in.
  ...
  Widget build(BuildContext context) {
    ...
    animationValue ??= 1.0;
    animationValue += 0.75 * (1 - animationValue);
    ...
    final RawImage image = RawImage(
      ...
      color: Color.fromRGBO(0, 0, 0, animationValue),
